...
const TodoList = ({CloseTodoList , FirstTodolist , SecondTodolist , ThirdTodolist , FourthTodolist,                                setFirstTodolist, setSecondTodolist, setThirdTodolist, setFourthTodolist}) => {
        ...
        <TODOLISTcontainer>
                <TODOLIST>
                    <TODOLISTimageContainer>
                        ...
                        <BackImageContainer onClick={CloseTodoList}><BackImage src={backImg} ></BackImage></BackImageContainer>
                    </TODOLISTimageContainer>
                    {TodoListSaveOpen===true && <TodolistSave 
                    ...
                    <NextTODOLIST onClick={ShowTodoListSave}>
                        ...
                        <DeleteTODOLIST src={backImg} onClick={handleDeleteClick}></DeleteTODOLIST>
                    </NextTODOLIST>
                    <NextTODOLIST>
